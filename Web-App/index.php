...
<body onload="init()">
    ...
    <div id="right" class="block">
        <div>
            <div id="Vorlage" class="text">
                Grundlegende Funktionen:</br></br>
            </div>
            <button id="button7" class = "button" type="button" onClick="go2(); changebed();">Generator</button>
            </br></br>
            <button id="button8" type="button" onClick="getData(), reloadbed();">Zeigen</button>
            </br></br>
            <button id="button14" type="button" onclick="window.location.href='ugan.php'">Neu</button>
        </div>
    </div>
</div>
